...
def generate_docx_report(data):
    ...
    mapping = {
        ...
        "IMC_N": medical.bmi,
        "PESO": medical.weight,
        "ALTURA": medical.height,
        "QUALI_SONO": medical.sleepQuality,
        "QUALI_DIETA": medical.dietQuality,
        "LDL_N": medical.cholesterolLdl,
        "HDL_N": medical.cholesterolHdl,
        "TRIGLIC": medical.cholesterolTriglycerides,
        "C_TOTAL": medical.cholesterolTotal,
        "PRESSAO_S": medical.systolicBP,
        "PRESSAO_D": medical.diastolicBP,
        ...
        "MMSE_N": medical.mmse,
        "ADL_N": medical.adl,
        "ATV_FUNC": medical.functionalAssessment,
