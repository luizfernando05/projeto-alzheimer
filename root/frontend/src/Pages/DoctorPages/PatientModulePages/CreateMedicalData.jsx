    ...
    <DoctorLayout>
      <section className="w-full">
        ...
        <div className="bg-gray-01 rounded-xl shadow-sm border border-gray-06">
          <div
            onClick={() => navigate(-1)}
            className="flex gap-6 pt-6 pb-6 pr-8 pl-8 border-b border-gray-06"
          >
          ...
          <form onSubmit={handleSubmit} className="pt-6 pr-8 pl-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <button
                type="submit"
                className="bg-indigo-09 text-indigo-01 px-6 py-2 rounded-md hover:bg-indigo-10 shadow-xs"
              >
                Realizar Cadastro
              </button>
