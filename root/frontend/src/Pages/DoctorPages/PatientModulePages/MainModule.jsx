        ...
        <div className="bg-gray-01 rounded-xl shadow-sm border border-gray-06">
          ...
          <div className="pt-6 pr-8 pl-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
              <div className="rounded-lg border border-gray-06 overflow-hidden">
                <div className="flex bg-gray-02 gap-6 pt-5 pb-5 pr-6 pl-6 border-b border-gray-06">
                  <h2 className="text-base font-poppins font-normal text-gray-12">
                    Opções
                  </h2>
                </div>
                <div className="bg-gray-02 pt-4 pb-5 pr-6 pl-6 flex flex-wrap gap-3">
